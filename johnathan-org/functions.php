...
function startwordpress_scripts() {
	wp_enqueue_style( 'css-base', get_template_directory_uri() . '/style.css', array(), '1.9.0' );
	wp_enqueue_style( 'css-screen', get_template_directory_uri() . '/assets/css/screen.css', array(), '1.9.0' );
